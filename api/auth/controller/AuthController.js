  ...
  async (req, res) => {
    try {
      ...
      if (!errors.isEmpty()) {
        ...
        const invite = await InviteModel.deleteOne({ email: { $regex: req.body.email.split('@')[1] } });
        ...
        if (user) {
          ...
          try {
            ...
            if (email) {
              ...
              const template = '<table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:auto; width:1003px"><tbody><tr><td style="vertical-align:top; width:997px">&nbsp;</td></tr><tr><td style="vertical-align:middle; width:997px"><p><img alt="" src="https://class.thestreamboard.com/boards/tools/svg/logo-final.png" style="display:block; height:auto; margin:auto; width:300px"/></p><h2 style="text-align:center"><span style="color:#ff9900">Congratulations!</span></h2></td></tr><tr><td style="vertical-align:middle; width:997px"><table style="width:1201px"><tbody><tr><td style="width:1189px"><h3 style="text-align:center">Hi ' + userData.username + ',</h3><h3 style="text-align:center">Registration Successfull</h3><h4 style="text-align:center">Please click the button below and create your own password.</h4><p style="text-align:center"><a class="btn btn-primary" href="https://admin.thestreamboard.com/#/pages/authentication/reset-password-v2?id=' + userData.userId + '">Create Password</a></p></td></tr></tbody></table></td></tr></tbody></table>';
              ...
              mailer([email, createData.itemail], template);
              userResponse = {
      ...
      if (!errors.isEmpty()) {
        ...
        if (user) {
          ...
          try {
            ...
            const template = '<table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:auto; width:1003px"><tbody><tr><td style="vertical-align:top; width:997px">&nbsp;</td></tr><tr><td style="vertical-align:middle; width:997px"><p><img alt="" src="https://class.thestreamboard.com/boards/tools/svg/logo-final.png" style="display:block; height:auto; margin:auto; width:300px"/></p><h2 style="text-align:center"><span style="color:#ff9900">Congratulations!</span></h2></td></tr><tr><td style="vertical-align:middle; width:997px"><table style="width:1201px"><tbody><tr><td style="width:1189px"><h3 style="text-align:center">Hi ' + teacherData.username + ',</h3><h3 style="text-align:center">Registration Successfull</h3><h4 style="text-align:center">Please click the button below and create your own password.</h4><p style="text-align:center"><a class="btn btn-primary" href="https://admin.thestreamboard.com/#/pages/authentication/reset-password-v2?id=' + teacherData.userId + '">Create Password</a></p></td></tr></tbody></table></td></tr></tbody></table>';
      ...
      if (!errors.isEmpty()) {
        ...
        if (user) {
          ...
          try {
            ...
            const template = '<table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:auto; width:1003px"><tbody><tr><td style="vertical-align:top; width:997px">&nbsp;</td></tr><tr><td style="vertical-align:middle; width:997px"><p><img alt="" src="https://class.thestreamboard.com/boards/tools/svg/logo-final.png" style="display:block; height:auto; margin:auto; width:300px"/></p><h2 style="text-align:center"><span style="color:#ff9900">Congratulations!</span></h2></td></tr><tr><td style="vertical-align:middle; width:997px"><table style="width:1201px"><tbody><tr><td style="width:1189px"><h3 style="text-align:center">Hi ' + studentData.username + ',</h3><h3 style="text-align:center">Registration Successfull</h3><h4 style="text-align:center">Please click the button below and create your own password.</h4><p style="text-align:center"><a class="btn btn-primary" href="https://admin.thestreamboard.com/#/pages/authentication/reset-password-v2?id=' + studentData.userId + '">Create Password</a></p></td></tr></tbody></table></td></tr></tbody></table>';
