    ...
    try {
      ...
      if (!errors.isEmpty()) {
        ...
        if (user) {
          ...
          const { address, location, organisation, email, password, username, mobile, countryCode, role, plan,
            status, teacherId, classId, grade, itemail, fullName, lastName } = req.body;
          const otp = utility.randomNumber(6);
