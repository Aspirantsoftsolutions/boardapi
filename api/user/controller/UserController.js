...
import SessionModel from "../../sessions/model/SessionModel.js";
import { AuthConstants } from "../../auth/const.js";
...
const getCounts = async (req, res) => {
  try {
    let counts = {
      ...
      individualsCount: 0,
      role: '',
      schoolsActiveCount: 0,
      schoolsInActiveCount: 0,
      schoolsPaidCount: 0,
      schoolsFreeCount: 0,
      teachersActiveCount: 0,
      teachersInActiveCount: 0,
      studentsActiveCount: 0,
      studentsInActiveCount: 0,
      quickSession: 0,
      liveSession: 0,
      scheduledSession: 0
    };
...
const InviteList = async (req, res) => {
  try {
    ...
    return successResponseWithData(res, 'success', invites);
  } catch (err) {
    console.log(err);
    return validationErrorWithData(res, UserConstants.errorOccurred, err);
  }
